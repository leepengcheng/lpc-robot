...
robot.findPath = function(self, startConfig, goalConfigs)
    ...
    simOMPL.setAlgorithm(task, self.OMPLAlgo) --设置算法
    ...
    for i = 1, self.numberOfOMPLCalculationsPasses do
        -- 等价于:
        ...
        local res, _path = simOMPL.compute(task, self.maxOMPLCalculationTime, -1, self.configCount)
